...
def fourier_comparison(data):
    ...
    # plt.plot(fftfreq(fft1.size, d=1/2478.9), fft1, color='red', label='generated', alpha=0.5)
    #
    # fft1 = fft(data)
    #
    # # change transparency of plot
    # plt.plot(fftfreq(fft1.size, d=1 / 2478.9), fft1, color='blue', label='real', alpha=0.5)
    # plt.ylim(0, 100)
    # plt.xlim(0, 1000)
    # plt.legend(loc='upper right')
    # plt.xlabel('Frequency (Hz)')
    # plt.ylabel('Power (W)')   # TODO: check if this is true
    # plt.show()
